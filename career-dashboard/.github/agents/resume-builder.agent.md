...
6. **Tailor the template**: change only content slots, project fields and relevance ordering. Keep a `% EVIDENCE:` tag before every content line. Tracks A/C put Experience first; B/D put Projects first. Never a years-of-experience total, a publication, a study-plan skill, a GPA, a certification or banned filler. The ~94% figure stays in the Dräger bullet.
