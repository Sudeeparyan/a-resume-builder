...
2. Run the posting sweep (`POST /api/v2/jobs/verify-due`, or leave it to the daily scheduler): expired and redirected postings are marked, and any posting whose live wording now refuses sponsorship moves to Excluded roles with the sentence.
